...
<form>
    <table>
        ...
        <tr>
            ...
            <td>
                <input type="radio" name="productClass" value="0">实物产品
                &nbsp;&nbsp;&nbsp;
                <input type="radio" name="productClass" value="1">虚拟电子产品
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
               <select name="productType">
                  ...
                  <option value="${productTypelist.productTypeId}" name="${productTypelist.productTypeId}">
        ...
        <tr>
            <td id="inputs">
                <input type="submit" value="提交" formaction="${pageContext.request.contextPath}/addProduct">
                &nbsp;&nbsp;
